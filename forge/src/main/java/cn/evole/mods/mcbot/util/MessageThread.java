...
public class MessageThread extends Thread{
    ...
    public void run() {
        switch (mode) {
            case 0 :{IMcBot.bot.sendGroupMsg(groupIDInt, messageString, autoEscape); break;}
            case 1 :{IMcBot.bot.sendGroupMsg(groupIDInt, messageArray, autoEscape); break;}
            case 2 :{IMcBot.bot.sendGuildMsg(guildIDString, channelIDString, messageString); break;}
            case 3 :{IMcBot.bot.sendGuildMsg(guildIDString, channelIDString, messageArray); break;}
        }
    }
